...
define(["require", "exports", "three", "../config"], function (require, exports, THREE, config_1) {
    ...
    var Light = /** @class */ (function () {
        function Light(Scene, options) {
            ...
            var _a = this.options, color = _a.color, intensity = _a.intensity, position = _a.position, shadowMapSize = _a.shadowMapSize;
        ...
        Light.prototype.update = function (position) {
            var _a = this.options.position, x = _a.x, y = _a.y, z = _a.z;
