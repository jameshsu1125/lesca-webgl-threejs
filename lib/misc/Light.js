...
define(["require", "exports", "three", "../config"], function (require, exports, THREE, config_1) {
    ...
    var defaultTY = {
        ...
        offset: config_1.light.spot.position.y,
    };
    var Light = /** @class */ (function () {
        ...
        Light.prototype.update = function (options) {
            if (!options.target)
                console.warn('[lesca-webgl-threejs]Three is no target[Mesh] to follow.');
            var opt = __assign(__assign({}, defaultTY), options);
            var target = opt.target, offsetY = opt.offsetY;
