...
var Webgl = exports["default"] = /*#__PURE__*/function () {
  function Webgl(options) {
    ...
    (0, _defineProperty2["default"])(this, "enterframe", _lescaEnterframe["default"]);
    ...
    this.renderer = new _Renderer["default"](this.options.renderer, this.options.camera.dom || null, this.camera);
  ...
  return (0, _createClass2["default"])(Webgl, [{
    ...
    value: function removeResizeListeners() {
