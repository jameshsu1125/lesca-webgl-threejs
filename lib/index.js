...
define(["require", "exports", "three", "./config", "./misc/Camera", "./misc/Light", "./misc/OrbitControls", "./misc/physicsMaterial", "./misc/physicWorld", "./misc/Renderer", "./misc/Sky", "lesca-enterframe"], function (require, exports, THREE, config_1, Camera_1, Light_1, OrbitControls_1, physicsMaterial_1, physicWorld_1, Renderer_1, Sky_1, lesca_enterframe_1) {
    "use strict";
    ...
    lesca_enterframe_1 = __importDefault(lesca_enterframe_1);
    ...
    var Webgl = /** @class */ (function () {
        function Webgl(options) {
            ...
            this.light = new Light_1.default(this.scene, this.options.light);
            ...
            var _a = this.options, physics = _a.physics, sky = _a.sky, stats = _a.stats;
            if (sky.enabled) {
            ...
            this.enterframe = lesca_enterframe_1.default;
            lesca_enterframe_1.default.setFPS(this.options.fps);
            lesca_enterframe_1.default.add(this.update);
            lesca_enterframe_1.default.play();
        }
        Webgl.prototype.setFPS = function (fps) {
            lesca_enterframe_1.default.setFPS(fps);
        };
